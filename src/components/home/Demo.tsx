      ...
      <div className="mockup-phone m-0">
        ...
        <div className="display">
          <div className="phone-1 artboard artboard-demo">
            ...
            {showCta && (
              <div className="flex w-full flex-1 items-center justify-center bg-amber-500 text-white">
                <span className="text-lg text-white">Call to action</span>
              </div>
            )}
            {showNewsletter && (
